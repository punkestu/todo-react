...
function Sidebar({ page, setPage }) {
  return (
    <nav className="bg-blue-950 text-slate-300 fill-slate-500 w-1/4 h-screen px-6 py-3">
      <h1 className="font-black text-3xl">Todo List</h1>
      <hr className="my-4" />
      <section className="font-medium flex flex-col gap-1 items-stretch text-slate-500">
        <SidebarButton currPage={page} page="dashboard" setPage={setPage}>
        ...
        <SidebarButton currPage={page} page="list" setPage={setPage}>
        ...
        <SidebarButton currPage={page} page="archive" setPage={setPage}>
